...
class TinyDTLS {
  ...
  late final _dtls_session_equalsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<session_t>,
  ...
  int dtls_p_hash(
    ...
    int keylen,
    ffi.Pointer<ffi.UnsignedChar> label,
    int labellen,
    ffi.Pointer<ffi.UnsignedChar> random1,
    int random1len,
    ffi.Pointer<ffi.UnsignedChar> random2,
    int random2len,
  ...
  void dtls_mac(
    ...
    ffi.Pointer<ffi.UnsignedChar> record,
  ...
  late final _dtls_macPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ...
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Size,
              ffi.Pointer<ffi.UnsignedChar>)>>('dtls_mac');
  ...
  int dtls_decrypt(
    ...
    ffi.Pointer<ffi.UnsignedChar> key,
    int keylen,
    ffi.Pointer<ffi.UnsignedChar> a_data,
    int a_data_length,
  ) {
  ...
  late final _dtls_psk_pre_master_secretPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Size,
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Size)>>('dtls_psk_pre_master_secret');
  ...
  int dtls_ecdh_pre_master_secret(
    ...
    ffi.Pointer<ffi.UnsignedChar> pub_key_x,
    ffi.Pointer<ffi.UnsignedChar> pub_key_y,
    int key_size,
    ffi.Pointer<ffi.UnsignedChar> result,
    int result_len,
  ) {
  ...
  late final _dtls_ecdh_pre_master_secretPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Size,
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Size)>>('dtls_ecdh_pre_master_secret');
  ...
  late final _dtls_ecdsa_generate_keyPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ...
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Size)>>('dtls_ecdsa_generate_key');
  ...
  void dtls_ecdsa_create_sig_hash(
    ffi.Pointer<ffi.UnsignedChar> priv_key,
    int key_size,
    ffi.Pointer<ffi.UnsignedChar> sign_hash,
    int sign_hash_size,
  ...
  void dtls_ecdsa_create_sig(
    ffi.Pointer<ffi.UnsignedChar> priv_key,
    int key_size,
    ffi.Pointer<ffi.UnsignedChar> client_random,
    int client_random_size,
    ffi.Pointer<ffi.UnsignedChar> server_random,
    int server_random_size,
    ffi.Pointer<ffi.UnsignedChar> keyx_params,
  ...
  int dtls_ecdsa_verify_sig_hash(
    ...
    ffi.Pointer<ffi.UnsignedChar> sign_hash,
    int sign_hash_size,
    ffi.Pointer<ffi.UnsignedChar> result_r,
    ffi.Pointer<ffi.UnsignedChar> result_s,
  ) {
  ...
  late final _dtls_ecdsa_verify_sig_hashPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Size,
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Pointer<ffi.UnsignedChar>)>>('dtls_ecdsa_verify_sig_hash');
  ...
  late final _dtls_ecdsa_verify_sigPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Size,
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Pointer<ffi.UnsignedChar>)>>('dtls_ecdsa_verify_sig');
  ...
  late final _dtls_ec_key_asn1_from_uint32Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Uint32>, ffi.Size,
              ffi.Pointer<ffi.UnsignedChar>)>>('dtls_ec_key_asn1_from_uint32');
  late final _dtls_ec_key_asn1_from_uint32 =
      _dtls_ec_key_asn1_from_uint32Ptr.asFunction<
          int Function(
              ffi.Pointer<ffi.Uint32>, int, ffi.Pointer<ffi.UnsignedChar>)>();
  ...
  late final _dtls_connectPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<dtls_context_t>,
  ...
  int dtls_writev(
    ...
    ffi.Pointer<ffi.Size> buf_len_array,
    int buf_array_len,
  ) {
    return _dtls_writev(
      ctx,
  ...
  late final _dtls_writevPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Size)>>('dtls_writev');
  late final _dtls_writev = _dtls_writevPtr.asFunction<
      int Function(ffi.Pointer<dtls_context_t>, ffi.Pointer<session_t>,
          ffi.Pointer<ffi.Pointer<uint8>>, ffi.Pointer<ffi.Size>, int)>();
  ...
  late final _dtls_writePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<dtls_context_t>, ffi.Pointer<session_t>,
              ffi.Pointer<uint8>, ffi.Size)>>('dtls_write');
  ...
  late final _dtls_handle_messagePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<dtls_context_t>, ffi.Pointer<session_t>,
              ffi.Pointer<uint8>, ffi.Int)>>('dtls_handle_message');
...
class dtls_handshake_parameters_psk_t extends ffi.Struct {
  ...
  @ffi.Array.multi([32])
  external ffi.Array<ffi.UnsignedChar> identity;
}
...
class dtls_ecdsa_key_t extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.UnsignedChar> priv_key;

  /// < private key as bytes >
  external ffi.Pointer<ffi.UnsignedChar> pub_key_x;

  /// < x part of the public key for the given private key >
  external ffi.Pointer<ffi.UnsignedChar> pub_key_y;
}

/// Holds global information of the DTLS engine.
class dtls_context_t extends ffi.Struct {
  @ffi.Array.multi([12])
  external ffi.Array<ffi.UnsignedChar> cookie_secret;
...
class dtls_handler_t extends ffi.Struct {
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<dtls_context_t>, ffi.Pointer<session_t>,
              ffi.Pointer<uint8>, ffi.Size)>> write;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<dtls_context_t>, ffi.Pointer<session_t>,
              ffi.Pointer<uint8>, ffi.Size)>> read;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<dtls_context_t>, ffi.Pointer<session_t>,
              ffi.Int32, ffi.UnsignedShort)>> event;
...
class dtls_record_header_t extends ffi.Struct {
  ...
  @ffi.Array.multi([2])
  external ffi.Array<ffi.UnsignedChar> version;

  @ffi.Array.multi([2])
  external ffi.Array<ffi.UnsignedChar> epoch;

  @ffi.Array.multi([6])
  external ffi.Array<ffi.UnsignedChar> sequence_number;

  @ffi.Array.multi([2])
  external ffi.Array<ffi.UnsignedChar> length;
}
...
class dtls_handshake_header_t extends ffi.Struct {
  ...
  @ffi.Array.multi([2])
  external ffi.Array<ffi.UnsignedChar> message_seq;

  @ffi.Array.multi([3])
  external ffi.Array<ffi.UnsignedChar> fragment_offset;

  @ffi.Array.multi([3])
  external ffi.Array<ffi.UnsignedChar> fragment_length;
}
...
class dtls_client_hello_t extends ffi.Struct {
  ...
  @ffi.Array.multi([4])
  external ffi.Array<ffi.UnsignedChar> gmt_random;

  @ffi.Array.multi([28])
  external ffi.Array<ffi.UnsignedChar> random;
}
